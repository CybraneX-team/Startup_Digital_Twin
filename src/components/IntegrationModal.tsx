      ...
      <div>
        ...
        <ResponsiveContainer width="100%" height={110}>
          <LineChart data={data.mrrHistory}>
            ...
            <Tooltip contentStyle={{ background: '#1e293b', border: '1px solid #334155', borderRadius: 8, fontSize: 12 }} formatter={(v: number) => [fmt$(v), 'MRR']} />
      ...
      <div>
        ...
        <ResponsiveContainer width="100%" height={120}>
          <BarChart data={data.topCampaigns} margin={{ left: -20 }}>
            ...
            <Tooltip contentStyle={{ background: '#1e293b', border: '1px solid #334155', borderRadius: 8, fontSize: 12 }} formatter={(v: number) => [fmt$(v), 'Spend']} />
      ...
      <div>
        ...
        <ResponsiveContainer width="100%" height={110}>
          <LineChart data={data.revenueHistory}>
            <XAxis dataKey="date" tick={{ fontSize: 10, fill: '#6b7280' }} axisLine={false} tickLine={false} />
            <YAxis tick={{ fontSize: 10, fill: '#6b7280' }} axisLine={false} tickLine={false} tickFormatter={(v) => `$${(v / 1000).toFixed(0)}K`} />
            <Tooltip contentStyle={{ background: '#1e293b', border: '1px solid #334155', borderRadius: 8, fontSize: 12 }} formatter={(v: number) => [fmt$(v), 'Revenue']} />
